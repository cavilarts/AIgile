...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: true, message: "Visual output data generated and ready for use!" });

  } catch (error) {
    console.error("Error generating JSON:", error);
    return NextResponse.json({ success: false, message: "An error occurred while generating the visual output data." }, { status: 500 });
  }
}
  */